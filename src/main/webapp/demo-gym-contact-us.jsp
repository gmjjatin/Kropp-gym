...
<script async src="https://www.googletagmanager.com/gtag/js?id=UA-88412799-2"></script>
<script>
  window.dataLayer = window.dataLayer || [];
  function gtag(){dataLayer.push(arguments);}
  gtag('js', new Date());

  gtag('config', 'UA-88412799-2');
</script>

<meta http-equiv="Content-Type" content="text/html; charset=ISO-8859-1">
<title>Best gym in Delhi</title>	

		<meta name="keywords" content="Best fitness center in paschim vihar Delhi" />
		<meta name="description" content="Best Gym in Delhi.Best Gym in West Delhi.Best Gym in New Delhi.Best Gym in Paschim vihar.">
	...
	<body>
		...
		<div class="body">
						...
						<div class="header-row">
								...
								<div class="header-row">
									<div class="header-logo">
										<a href="demo-gym.html">
											<img alt="Best Gym in Delhi" width="143" height="50" src="img/demos/gym/logo.png">
										</a>
										<!-- <a class="btn btn-primary  text-uppercase custom-font-weight-medium" href="demo-gym.html">Best Gym</a> -->
									</div>
								</div>
							</div>
										...
										<div class="header-nav-main header-nav-main-effect-1 header-nav-main-sub-effect-1">
											<nav class="collapse">
												<ul class="nav nav-pills" id="mainNav">
													<li>
														<a class="nav-link" href="demo-gym.html">
															Home
														</a>
													</li>
													<li>
														<a class="nav-link" href="demo-gym-about-us.html">
															About Us
														</a>
													</li>
													<li class="dropdown">
														<a class="nav-link dropdown-toggle" href="demo-gym-classes.html">
															Classes
														</a>
														<ul class="dropdown-menu">
															<li><a class="dropdown-item" href="demo-gym-classes.html">Overview</a></li>
															<li><a class="dropdown-item" href="demo-gym-classes-detail.html">Group Fitness</a></li>
															<li><a class="dropdown-item" href="demo-gym-classes-detail.html">Yoga</a></li>
															<li><a class="dropdown-item" href="demo-gym-classes-detail.html">Functional</a></li>
															<li><a class="dropdown-item" href="demo-gym-classes-detail.html">Spin Class</a></li>
															<li><a class="dropdown-item" href="demo-gym-classes-detail.html">Zumba</a></li>
															<li><a class="dropdown-item" href="demo-gym-classes-detail.html">Conditioning</a></li>
														</ul>
													</li>
													<li>
														<a class="nav-link" href="demo-gym-staff.html">
															Staff
														</a>
													</li>
													<li>
														<a class="nav-link" href="demo-gym-pricing.html">
															Pricing
														</a>
													</li>
													<li>
														<a class="nav-link active" href="demo-gym-contact-us.html">
															Contact Us
														</a>
													</li>
												</ul>
							...
							<div class="header-column justify-content-end">
								<div class="header-row custom-sm-btn-header-style-1">
									<a class="btn btn-primary btn-join-now text-uppercase custom-font-weight-medium" href="demo-gym-contact-us.html">Join Now</a>
					...
					<div class="container">
						<div class="row">
							<div class="col-lg-9 mb-4 mb-lg-0">
								...
								<p class="mb-5 pb-2">Best gym in pashcim vihar invites to join us , get in contact with us.</p>
								<div class="row">
									<div class="col-md-4">
										<div class="custom-location">
											<img src="img/demos/gym/map/pin.png" alt class="img-fluid" />
											<h6 class="font-weight-bold text-color-quaternary text-5 mb-1">West Delhi</h6>
											<p>
												Dummy Gym , Paschim Vihar <br>
												West Delhi Delhi-11063<br>
									...
									<div class="col-md-4">
										<div class="custom-location">
											<img src="img/demos/gym/map/pin.png" alt class="img-fluid" />
											<h6 class="font-weight-bold text-color-quaternary text-5 mb-1">Gurugram</h6>
											<p>
												Dummy Gym, Other Branch<br>
												New Delhi<br>
												<strong>Phone:</strong> <a href="tel:+123456789" class="text-color-dark">123-456-7890</a>
											</p>
										</div>
							...
							<div class="col-lg-3">
								<div class="custom-join-now-form custom-position-style-2 background-color-primary p-4">
									...
									<p class="font-weight-light text-color-light text-2">Get a free 1 day VIP guest pass.</p>
									<form id="vipRequest" action="/PassMakerController" method="POST">
										<%
										String status=(String)request.getAttribute("status");
										if("ok".equals(status)){ %>
										<div class="alert-success alert mt-4" id="vipRequestSuccess"> 
										<strong>Success!</strong> Your VIP request has been sent to us and we have mailed you the pass.
									</div>
									<%} %>

								<!-- for not ok -->
								<%		
								if("notOk".equals(status)) {
											String date=(String)request.getAttribute("date");
									%>
								<div class="alert alert-danger mt-4" id="vipRequestErrorMessage">
									<strong>Error!</strong> There was an error sending your VIP.
									request. <span class="text-1 mt-2 d-block"
										 id="vipRequestErrorMessage"> We have already mailed you on <%=date %></span>
								</div>
								<%} %>
					...
					<div class="container">
						<div class="row">
							<div class="col-lg-7">
								...
								<form id="contactFormMessage" class="custom-form-style-1" action="#" method="POST">
								...
								<div class="owl-carousel custom-dots-style-2 custom-dots-bottom-left-1" data-plugin-options="{'items': 1, 'loop': false, 'dots': true, 'nav': false}">
									<div class="custom-resources-style">
										...
										<span class="content">
											...
											<p>Containing awesome passages, and more recently with desktop publishing software like aldus.</p>
										</span>
									</div>
									<div class="custom-resources-style">
			...
			<footer id="footer" class="background-color-quaternary">
				<div class="container">
					...
					<div class="row mt-2">
						<div class="col-lg-12 text-center">
							<p>2018 © Best Gym in Delhi <strong class="text-color-light font-weight-normal">The Gym</strong> Copyright All Rights Reserved.</p>
						</div>
					</div>
				</div>
			</footer>
		...
		<script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyCWG-y8hQMcEMKIqqZgvNeh0ZMsmRuf8zc"></script>
		<script>
			...
			*/
			...
			// Map Markers
						var mapMarkers = [ {
				address : "Paschim Vihar ,New Delhi,Delhi",
				html : "<div class='map-info-box'><strong>Address:</strong><br>Best Gym 123<br>Paschim Vihar ,<br>New Delhi,Delhi<br><strong>Phone: </strong><a href='tel:+9999999999'>999-999-9999</a><div class='map-info-box-image' style='background: url(img/demos/gym/map/map-location-image.jpg); background-size: cover;'></div></div>",
				icon : {
			...
			var initLatitude = 28.667096498769688;
			var initLongitude = 77.10439931128417;
